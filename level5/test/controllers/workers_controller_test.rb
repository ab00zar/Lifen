...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post workers_url, params: { worker: { first_name: @worker.first_name, status: @worker.status } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { first_name: @worker.first_name, status: @worker.status } }
